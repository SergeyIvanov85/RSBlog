  ...
  <div className='post__wrapper'>
    ...
    <div className='comments'>
      ...
      <form className='' onSubmit={(e) => e.preventDefault()}>
        <textarea className='' rows="10" cols="45" name="text" value={comment} onChange={(e) => setComment(e.target.value)} placeholder='Комментировать'></textarea>
      </form>

      <div className='comments__buttons'>
        <button className='btn btn_small' type='submit' onClick={handlerSubmit}>Отправить</button>
      </div>
    </div>
  </div>
    </div>
